...
class Admin(User):
    def __init__(self, first_name, second_name, age, phone_number, year_of_birth):
        User.__init__(self, first_name, second_name, age, phone_number, year_of_birth)
        self.privileges=["Добавлять сообщения", "Додбавлять участников", "Удалять участников", "Банить участников"]
    def show_privileges(self):
        p=self.privileges
        print(f"Привилегии администратора: ")
        for i in p:
            print(f"~~~{i}")
...
admin=Admin(first_name, second_name, age, phone_number, year_of_birth)
